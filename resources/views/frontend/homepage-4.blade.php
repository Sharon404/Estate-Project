                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-start wow fadeInRight">
                                <h1 class="fs-120 fs-sm-10vw mb-0 lh-1">Luxury Comfort</h1>
                            </div>
                            <div class="text-lg-end wow fadeInLeft">
                                <h1 class="fs-120 fs-sm-10vw mb-4 lh-1">Timeless Elegance</h1>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row g-4 gx-5 align-items-center justify-content-between">
                    ...
                    <div class="col-lg-6">
                        ...
                        <a class="btn-main fx-slide wow fadeInUp" data-wow-delay=".6s" href="#rooms"><span>Explore Our Rooms</span></a>
