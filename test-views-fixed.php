...
$viewTests = [
    ...
    'admin/users/show' => ['user' => new TestModel(1, [
    ...
    'admin/properties/show' => ['property' => new TestModel(1, [
        'name' => 'Test Property', 'location' => 'Nairobi', 'description' => 'Test',
        ...
        'bookings_count' => 0, 'total_revenue' => 0, 'average_rating' => 0, 'bookings' => collect([])
    ])],
    'admin/properties/edit' => ['property' => new TestModel(1, [
        'name' => 'Test Property', 'location' => 'Nairobi', 'description' => 'Test',
        'property_type' => 'apartment', 'bedrooms' => 2, 'bathrooms' => 1, 'max_guests' => 4,
    ...
    'admin/refunds/show' => ['refund' => new TestModel(1, [
        'booking_id' => 1, 'amount' => 5000, 'reason' => 'Test', 'status' => 'PENDING',
    ...
    'admin/tickets/show' => ['ticket' => new TestModel(1, [
        'ticket_number' => 'TKT-001', 'subject' => 'Test', 'message' => 'Test message',
    ...
    'admin/payouts/show' => ['payout' => new TestModel(1, [
        'payout_ref' => 'PYT-001', 'payee_type' => 'OWNER', 'gross_amount' => 10000,
    ...
    'staff/bookings/show' => ['booking' => new TestModel(1, [
        'check_in_date' => now(), 'check_out_date' => now()->addDays(2),
    ...
    'staff/verification/show' => ['booking' => new TestModel(1, [
        'check_in_date' => now(), 'check_out_date' => now()->addDays(2),
    ...
    'staff/tickets/show' => ['ticket' => new TestModel(1, [
        'ticket_number' => 'TKT-001', 'subject' => 'Test', 'message' => 'Test message',
